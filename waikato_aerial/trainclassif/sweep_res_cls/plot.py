    ...
    for class_name, class_data in data.items():
        for model_name, model_data in class_data.items():
            for metric in METRICS:
                ...
                save_name = f"{class_name.replace(' ', '_')}_{model_name}_{metric}.png"
...
if __name__ == "__main__":
    ...
    output_dir = "C:/Users/arcad/Downloads/d/repo/aerial-image-classification/waikato_aerial/trainclassif/sweep_res_cls/results/classwise_plots"
