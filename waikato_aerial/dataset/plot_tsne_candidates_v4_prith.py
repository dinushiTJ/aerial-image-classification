...
# --- CLIP MODEL SETUP ---
prithvi_model = AutoModel.from_pretrained("ibm-nasa-geospatial/Prithvi-EO-1.0-100M").eval().cuda()
prithvi_processor = AutoImageProcessor.from_pretrained("ibm-nasa-geospatial/Prithvi-EO-1.0-100M")
